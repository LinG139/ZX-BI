...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        return userRegister(userAccount, userPassword, checkPassword, null, null);
    }
    ...
    public boolean updateUserChartCount(HttpServletRequest request) {
        ...
        boolean result = updateUserChartCount(userId);
        if (!result) {
            return false;
        }
        return true;
    ...
    @Override
    public boolean updateUserChartCount(Long userId) {
